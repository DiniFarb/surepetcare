...
class PetCare extends EventEmitter {
    ...
    async #getTodaysTimeline() {
        try {
            ...
            console.error(`Today timeline fetching failed: ${err}`);
    ...
    async #getAllRecentTimelineEntries(){
        try {
            ...
            console.error(`All timeline entries fetching failed: ${err}`);
    ...
    setDoorState(name = String, command = Number) {
        try {
            ...
            console.error(`set door state error: ${err}`);
    ...
    setPetPlace(name = String, command = Number) {
        ...
        try {
            ...
            console.error(`set pet place failed: ${err}`);
    ...
    resetFeeders(command = Number) {
        ...
        try {
                ...
                sleep().then(()=>{
                    ...
                    .then(res => {
                        if (res.results){
                            ...
                            console.error(`feeder ${devices[i].name}: result was undefined`);
            ...
            console.error(`reset feeders failed: ${err}`);
    ...
    resetFeeder(name = String, command = Number) {
        ...
        try {
            ...
            console.error(`reset feeder failed: ${err}`);
    ...
    getPetReport() {
        ...
        try {
            ...
            console.error(`Pet report error: ${err}`);
