export default class Utils {
    ...
    constructor(options = {}){
        ...
        this.somethingWrongMsg = options.somethingWrongMsg || "something is wrong";
        this.successMsg = options.successMsg || "ok";
        this.doorStates = {
            0: options.doorOpenText || "open",
            1: options.doorlockedInText || "locked in",
            2: options.doorlockedOutText || "locked out",
            3: options.doorlockedAllText || "locked",
        }
        this.placeNames = {
        ...
        this.tareText = {
            1:options.tareLeftText || "left",
            2:options.tareRightText || "right",
            3:options.tareBothText || "both",
        }
        ...
        this.petHasEatenText = options.petHasEatenText || this.#default_petHasEatenText;
    ...
    #default_petHasEatenText = (petName, left, right) => `${petName} has eaton ${left}g${right ? 
